...
#[Route('/api/v1/training/workout', name: 'api_training_workout_get_one', methods: ['GET'])]
readonly class GetOneWorkoutApiController
{
    ...
    public function __invoke(Request $request): JsonResponse
    {
        ...
        $query = new GetOneWorkoutQuery($workoutId);
